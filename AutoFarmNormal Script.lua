...
print('Ty for Using This Script')
...
Players.LocalPlayer.leaderstats.Raised.Changed:Connect(function()
	...
	if getgenv().settings.webhookToggle and getgenv().settings.webhookBox then
		...
		webhook("💰 Tip | Amount: " .. tostring(Players.LocalPlayer.leaderstats.Raised.Value - RaisedC) .. 'R$ | Total: ' .. tostring(Players.LocalPlayer.leaderstats.Raised.Value) .. 'R$ | Account: ' .. Players.LocalPlayer.DisplayName .. ' (' .. Players.LocalPlayer.Name .. ')')
	end
...
msgdone.OnClientEvent:Connect(function(msgdata)
	...
	if plrChatted == game:GetService('Players').LocalPlayer or getgenv().settings.autoNearReply == false then return end
...
if game:GetService("CoreGui").imgui.Windows.Window.Title.Text == "Loading..." then
	game:GetService("CoreGui").imgui.Windows.Window.Title.Text = "Caught Leaked Tzecho"
end
